    ...
    <form className="auth-form" onSubmit={onSubmit} noValidate>
      ...
      <label className="field">
        <div className="field-label-row">
          ...
          <a href="#" className="field-forgot">Şifremi unuttum</a>
        </div>
      ...
      {success && <div className="auth-alert auth-alert-success">Giriş başarılı!</div>}
      ...
      <p className="auth-legal">
        Devam ederek <button type="button" className="auth-legal-link" onClick={() => setLegalModal({ isOpen: true, type: 'terms' })}>Kullanım Koşulları</button> ve{' '}
        <button type="button" className="auth-legal-link" onClick={() => setLegalModal({ isOpen: true, type: 'privacy' })}>Gizlilik Politikası</button>'nı kabul etmiş olursun.
      </p>
